...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <ASIDE class="aside_left">
    ...
    <A href="../cate/list.do?categrpno=${categrpVO.categrpno }">${categrpVO.name }</A> > ${cateVO.name} > 등록 
  </ASIDE>
  ...
  <DIV style='width: 100%;'>
    <FORM name='frm' method='POST' action='./create.do' class="form-horizontal"
      ...
      <div class="form-group">   
        <div class="col-md-12">
          <input type='text' class="form-control" name='word'  value='겨울,12월' placeholder="검색어" style='width: 90%;'>
        </div>
      </div>
