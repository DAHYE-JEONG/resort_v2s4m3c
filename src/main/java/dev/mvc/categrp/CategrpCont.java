...
public class CategrpCont {
  ...
  public ModelAndView create(CategrpVO categrpVO) {
    ...
    if(cnt == 0) {
      ...
      mav.setViewName("redirect:/categrp/msg.do"); // /webapp/categrp/create_msg.jsp
    } else {
  ...
  /**
   * Ajax 기반 등록 처리 http://localhost:9090/resort/categrp/create.do
   * 
   * @return
   */
  @ResponseBody
...
//  }
  ...
  /**
   * Ajax 기반 수 처리 http://localhost:9090/resort/categrp/update_ajax.do
   * 
   * @return
   */
  @ResponseBody
  ...
  public String delete_ajax(int categrpno) {
    ...
    int cnt = this.categrpProc.delete(categrpno); // 삭 처리
